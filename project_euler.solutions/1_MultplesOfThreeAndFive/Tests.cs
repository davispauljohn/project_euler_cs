...
namespace project_euler.tests
{
    ...
    public class MultiplesOfThreeAndFiveTests
    {
        ...
        {
            MultiplesOfThreeAndFive.GetMultiplesOfThreeAndFive(1000).ShouldBe(233168);
        }
    }
}